...
use windows::core::{BSTR, GUID, PCWSTR}; // From the 'windows' crate
// S_OK is defined here
...
use windows::Win32::System::Variant::{VT_BSTR, VariantClear, VariantInit};
// For ptr::null_mut()
...
pub unsafe fn set_string_property(
    ...
    unsafe {
        ...
        let prop_name_bstr = BSTR::from(property_name);
        ...
        if dispid == DISPID_UNKNOWN {
            eprintln!(
                "Failed to get DISPID for property '{}': {:?}",
                property_name, hr
            );
        ...
        let mut args_variant = VariantInit();
        ...
        (*args_variant.Anonymous.Anonymous).Anonymous.bstrVal =
            std::mem::ManuallyDrop::new(BSTR::from(new_value));
        ...
        let hr = dispatch.Invoke(
            ...
            None,
        ); // puArgErr: No argument error info needed
