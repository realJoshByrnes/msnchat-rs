...
use windows::Win32::System::Ole::{
    IOleInPlaceSite_Vtbl, IOleInPlaceSiteEx_Vtbl, IOleWindow_Vtbl, OLEINPLACEFRAMEINFO,
};
...
pub struct MyOleInPlaceSiteEx {
    pub lp_vtbl: *const IOleInPlaceSiteEx_Vtbl,
...
pub unsafe extern "system" fn query_interface(
    ...
    unsafe {
        ...
        println!("MyOleInPlaceSiteEx::QueryInterface called for {:?}", *riid);
        *ppv = ptr::null_mut();
        E_NOINTERFACE
    }
}
...
unsafe extern "system" fn get_window_context(
    ...
    unsafe {
        ...
        let hwnd = (*(*this.cast::<MyOleInPlaceSiteEx>()).shared).hwnd;
